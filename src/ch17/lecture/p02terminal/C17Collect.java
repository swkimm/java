...
public class C17Collect {
	public static void main(String[] args) {
		...
		Map<String, IntSummaryStatistics> r2 = list.stream()
				.collect(Collectors.groupingBy(Car::getType, Collectors.summarizingInt(Car::getPrice)));
